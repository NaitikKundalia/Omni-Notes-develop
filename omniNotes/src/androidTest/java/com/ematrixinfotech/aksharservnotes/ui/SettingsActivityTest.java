package com.ematrixinfotech.aksharservnotes.ui;
...
import static com.ematrixinfotech.aksharservnotes.utils.VisibleViewMatcher.isVisible;
...
import com.ematrixinfotech.aksharservnotes.utils.IsEqualTrimmingAndIgnoringCase;
...
public class SettingsActivityTest extends BaseEspressoTest {
  ...
  public void settingsActivityTest() {
    onView(allOf(
        ViewMatchers.withContentDescription(IsEqualTrimmingAndIgnoringCase.equalToTrimmingAndIgnoringCase("drawer open")),
        isVisible(),
        isDescendantOfA(
    ...
    onView(allOf(
        ...
        hasDescendant(
            allOf(
                ...
                withTextOrHint(IsEqualTrimmingAndIgnoringCase.equalToTrimmingAndIgnoringCase("SETTINGS")))),
        isDescendantOfA(
            allOf(
