...
package com.ematrixinfotech.aksharservnotes.widget;
...
public abstract class WidgetProvider extends AppWidgetProvider {
  ...
  private void setLayout(Context context, AppWidgetManager appWidgetManager, int widgetId) {
    ...
    intentDetail.setAction(ConstantsBase.ACTION_WIDGET);
    intentDetail.putExtra(ConstantsBase.INTENT_WIDGET, widgetId);
    ...
    intentList.setAction(ConstantsBase.ACTION_WIDGET_SHOW_LIST);
    intentList.putExtra(ConstantsBase.INTENT_WIDGET, widgetId);
    ...
    intentDetailPhoto.setAction(ConstantsBase.ACTION_WIDGET_TAKE_PHOTO);
    intentDetailPhoto.putExtra(ConstantsBase.INTENT_WIDGET, widgetId);
