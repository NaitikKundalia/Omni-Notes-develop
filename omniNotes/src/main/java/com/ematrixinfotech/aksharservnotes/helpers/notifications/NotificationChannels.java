...
package com.ematrixinfotech.aksharservnotes.helpers.notifications;
...
public class NotificationChannels {
  ...
  static {
    ...
    channels.put(NotificationChannelNames.REMINDERS, new NotificationChannel(
        ...
        Constants.CHANNEL_REMINDERS_ID));
