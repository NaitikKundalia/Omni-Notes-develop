...
public class AppVersionHelper {
  ...
  public static int getAppVersionFromPreferences(Context context)
    ...
    try {
      return context.getSharedPreferences(Constants.PREFS_NAME,
          Context.MODE_MULTI_PROCESS).getInt(ConstantsBase.PREF_CURRENT_APP_VERSION, 1);
  ...
  public static void updateAppVersionInPreferences(Context context)
    ...
    context.getSharedPreferences(Constants.PREFS_NAME,
        ...
        .putInt(ConstantsBase.PREF_CURRENT_APP_VERSION, getCurrentAppVersion(context)).apply();
  }
