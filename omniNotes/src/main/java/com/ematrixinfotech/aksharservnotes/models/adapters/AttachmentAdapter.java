 ...
 */
package com.ematrixinfotech.aksharservnotes.models.adapters;
...
import com.ematrixinfotech.aksharservnotes.models.views.SquareImageView;
...
public class AttachmentAdapter extends BaseAdapter {
  ...
  public View getView(int position, View convertView, ViewGroup parent) {
    ...
    if (mAttachment.getMime_type() != null && mAttachment.getMime_type().equals(ConstantsBase.MIME_TYPE_AUDIO)) {
      String text;
      ...
      if (mAttachment.getLength() > 0) {
        ...
        text = DateUtils.getLocalizedDateTime(mActivity, mAttachment
            .getUri().getLastPathSegment().split("\\.")[0], ConstantsBase.DATE_FORMAT_SORTABLE);
      }
    ...
    if (mAttachment.getMime_type() != null && mAttachment.getMime_type().equals(ConstantsBase.MIME_TYPE_FILES)) {
