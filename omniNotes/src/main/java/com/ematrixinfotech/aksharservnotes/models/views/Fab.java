...
package com.ematrixinfotech.aksharservnotes.models.views;
...
import com.ematrixinfotech.aksharservnotes.models.listeners.AbsListViewScrollDetector;
import com.ematrixinfotech.aksharservnotes.models.listeners.OnFabItemClickedListener;
...
public class Fab {
  ...
  private void animateFab(int translationY, final int visibilityBefore, final int visibilityAfter) {
    animate(floatingActionsMenu).setInterpolator(new AccelerateDecelerateInterpolator())
        .setDuration(ConstantsBase.FAB_ANIMATION_TIME)
