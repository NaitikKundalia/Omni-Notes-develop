...
package it.ematrixinfotech.aksharservnotes;

import static it.ematrixinfotech.aksharservnotes.async.bus.SwitchFragmentEvent.Direction.CHILDREN;
...
import it.ematrixinfotech.aksharservnotes.async.CategoryMenuTask;
import it.ematrixinfotech.aksharservnotes.async.MainMenuTask;
import it.ematrixinfotech.aksharservnotes.async.bus.CategoriesUpdatedEvent;
import it.ematrixinfotech.aksharservnotes.async.bus.DynamicNavigationReadyEvent;
import it.ematrixinfotech.aksharservnotes.async.bus.NavigationUpdatedEvent;
import it.ematrixinfotech.aksharservnotes.async.bus.NavigationUpdatedNavDrawerClosedEvent;
import it.ematrixinfotech.aksharservnotes.async.bus.NotesLoadedEvent;
import it.ematrixinfotech.aksharservnotes.async.bus.NotesUpdatedEvent;
import it.ematrixinfotech.aksharservnotes.async.bus.SwitchFragmentEvent;
import it.ematrixinfotech.aksharservnotes.models.Category;
import it.ematrixinfotech.aksharservnotes.models.NavigationItem;
import it.ematrixinfotech.aksharservnotes.utils.Display;
