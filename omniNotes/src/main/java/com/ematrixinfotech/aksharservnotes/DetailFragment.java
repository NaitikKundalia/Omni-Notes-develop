 ...
 */
package com.ematrixinfotech.aksharservnotes;

import static android.content.Context.CLIPBOARD_SERVICE;
import static android.content.Context.LAYOUT_INFLATER_SERVICE;
import static androidx.core.view.ViewCompat.animate;
import static com.ematrixinfotech.aksharservnotes.BaseActivity.TRANSITION_HORIZONTAL;
import static com.ematrixinfotech.aksharservnotes.BaseActivity.TRANSITION_VERTICAL;
import static com.ematrixinfotech.aksharservnotes.MainActivity.FRAGMENT_DETAIL_TAG;
import static com.ematrixinfotech.aksharservnotes.utils.ConstantsBase.ACTION_DISMISS;
import static com.ematrixinfotech.aksharservnotes.utils.ConstantsBase.ACTION_FAB_TAKE_PHOTO;
import static com.ematrixinfotech.aksharservnotes.utils.ConstantsBase.ACTION_MERGE;
import static com.ematrixinfotech.aksharservnotes.utils.ConstantsBase.ACTION_NOTIFICATION_CLICK;
import static com.ematrixinfotech.aksharservnotes.utils.ConstantsBase.ACTION_PINNED;
import static com.ematrixinfotech.aksharservnotes.utils.ConstantsBase.ACTION_SHORTCUT;
import static com.ematrixinfotech.aksharservnotes.utils.ConstantsBase.ACTION_SHORTCUT_WIDGET;
import static com.ematrixinfotech.aksharservnotes.utils.ConstantsBase.ACTION_WIDGET;
import static com.ematrixinfotech.aksharservnotes.utils.ConstantsBase.ACTION_WIDGET_SHOW_LIST;
import static com.ematrixinfotech.aksharservnotes.utils.ConstantsBase.ACTION_WIDGET_TAKE_PHOTO;
import static com.ematrixinfotech.aksharservnotes.utils.ConstantsBase.GALLERY_CLICKED_IMAGE;
import static com.ematrixinfotech.aksharservnotes.utils.ConstantsBase.GALLERY_IMAGES;
import static com.ematrixinfotech.aksharservnotes.utils.ConstantsBase.GALLERY_TITLE;
import static com.ematrixinfotech.aksharservnotes.utils.ConstantsBase.INTENT_GOOGLE_NOW;
import static com.ematrixinfotech.aksharservnotes.utils.ConstantsBase.INTENT_KEY;
import static com.ematrixinfotech.aksharservnotes.utils.ConstantsBase.INTENT_NOTE;
import static com.ematrixinfotech.aksharservnotes.utils.ConstantsBase.INTENT_WIDGET;
import static com.ematrixinfotech.aksharservnotes.utils.ConstantsBase.MIME_TYPE_AUDIO;
import static com.ematrixinfotech.aksharservnotes.utils.ConstantsBase.MIME_TYPE_AUDIO_EXT;
import static com.ematrixinfotech.aksharservnotes.utils.ConstantsBase.MIME_TYPE_FILES;
import static com.ematrixinfotech.aksharservnotes.utils.ConstantsBase.MIME_TYPE_IMAGE;
import static com.ematrixinfotech.aksharservnotes.utils.ConstantsBase.MIME_TYPE_IMAGE_EXT;
import static com.ematrixinfotech.aksharservnotes.utils.ConstantsBase.MIME_TYPE_SKETCH;
import static com.ematrixinfotech.aksharservnotes.utils.ConstantsBase.MIME_TYPE_SKETCH_EXT;
import static com.ematrixinfotech.aksharservnotes.utils.ConstantsBase.MIME_TYPE_VIDEO;
import static com.ematrixinfotech.aksharservnotes.utils.ConstantsBase.MIME_TYPE_VIDEO_EXT;
import static com.ematrixinfotech.aksharservnotes.utils.ConstantsBase.PREF_ATTACHMENTS_ON_BOTTOM;
import static com.ematrixinfotech.aksharservnotes.utils.ConstantsBase.PREF_AUTO_LOCATION;
import static com.ematrixinfotech.aksharservnotes.utils.ConstantsBase.PREF_COLORS_APP_DEFAULT;
import static com.ematrixinfotech.aksharservnotes.utils.ConstantsBase.PREF_KEEP_CHECKED;
import static com.ematrixinfotech.aksharservnotes.utils.ConstantsBase.PREF_KEEP_CHECKMARKS;
import static com.ematrixinfotech.aksharservnotes.utils.ConstantsBase.PREF_PASSWORD;
import static com.ematrixinfotech.aksharservnotes.utils.ConstantsBase.PREF_PRETTIFIED_DATES;
import static com.ematrixinfotech.aksharservnotes.utils.ConstantsBase.PREF_WIDGET_PREFIX;
import static com.ematrixinfotech.aksharservnotes.utils.ConstantsBase.SWIPE_MARGIN;
import static com.ematrixinfotech.aksharservnotes.utils.ConstantsBase.SWIPE_OFFSET;
import static com.ematrixinfotech.aksharservnotes.utils.ConstantsBase.THUMBNAIL_SIZE;
...
import com.ematrixinfotech.aksharservnotes.models.ONStyle;
import com.ematrixinfotech.aksharservnotes.models.adapters.AttachmentAdapter;
import com.ematrixinfotech.aksharservnotes.models.adapters.CategoryRecyclerViewAdapter;
import com.ematrixinfotech.aksharservnotes.models.adapters.PlacesAutoCompleteAdapter;
import com.ematrixinfotech.aksharservnotes.models.listeners.OnAttachingFileListener;
import com.ematrixinfotech.aksharservnotes.models.listeners.OnGeoUtilResultListener;
import com.ematrixinfotech.aksharservnotes.models.listeners.OnNoteSaved;
import com.ematrixinfotech.aksharservnotes.models.listeners.OnReminderPickedListener;
import com.ematrixinfotech.aksharservnotes.models.listeners.RecyclerViewItemClickSupport;
import com.ematrixinfotech.aksharservnotes.models.views.ExpandableHeightGridView;
...
import com.ematrixinfotech.aksharservnotes.async.AttachmentTask;
import com.ematrixinfotech.aksharservnotes.async.bus.NotesUpdatedEvent;
import com.ematrixinfotech.aksharservnotes.async.bus.PushbulletReplyEvent;
import com.ematrixinfotech.aksharservnotes.async.bus.SwitchFragmentEvent;
import com.ematrixinfotech.aksharservnotes.async.notes.NoteProcessorDelete;
import com.ematrixinfotech.aksharservnotes.async.notes.SaveNoteTask;
import it.feio.android.omninotes.databinding.FragmentDetailBinding;
import com.ematrixinfotech.aksharservnotes.db.DbHelper;
import com.ematrixinfotech.aksharservnotes.helpers.AttachmentsHelper;
...
import com.ematrixinfotech.aksharservnotes.helpers.PermissionsHelper;
import com.ematrixinfotech.aksharservnotes.helpers.TagOpenerHelper;
import com.ematrixinfotech.aksharservnotes.helpers.date.DateHelper;
import com.ematrixinfotech.aksharservnotes.helpers.date.RecurrenceHelper;
import com.ematrixinfotech.aksharservnotes.helpers.notifications.NotificationChannels.NotificationChannelNames;
import com.ematrixinfotech.aksharservnotes.helpers.notifications.NotificationsHelper;
import com.ematrixinfotech.aksharservnotes.models.Category;
import com.ematrixinfotech.aksharservnotes.models.Note;
import com.ematrixinfotech.aksharservnotes.models.Tag;
import com.ematrixinfotech.aksharservnotes.utils.AlphaManager;
import com.ematrixinfotech.aksharservnotes.utils.BitmapHelper;
import com.ematrixinfotech.aksharservnotes.utils.ConnectionManager;
import com.ematrixinfotech.aksharservnotes.utils.Display;
import com.ematrixinfotech.aksharservnotes.utils.FileHelper;
import com.ematrixinfotech.aksharservnotes.utils.FileProviderHelper;
import com.ematrixinfotech.aksharservnotes.utils.GeocodeHelper;
import com.ematrixinfotech.aksharservnotes.utils.IntentChecker;
import com.ematrixinfotech.aksharservnotes.utils.KeyboardUtils;
import com.ematrixinfotech.aksharservnotes.utils.PasswordHelper;
import com.ematrixinfotech.aksharservnotes.utils.ReminderHelper;
import com.ematrixinfotech.aksharservnotes.utils.ShortcutHelper;
import com.ematrixinfotech.aksharservnotes.utils.StorageHelper;
import com.ematrixinfotech.aksharservnotes.utils.TagsHelper;
import com.ematrixinfotech.aksharservnotes.utils.TextHelper;
import com.ematrixinfotech.aksharservnotes.utils.date.DateUtils;
import com.ematrixinfotech.aksharservnotes.utils.date.ReminderPickers;
...
public class DetailFragment extends BaseFragment implements OnReminderPickedListener,
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container,
    ...
    mEditor = (RichEditor) view.findViewById(R.id.detail_content);
...
//					((View)event.getLocalState()).setVisibility(View.VISIBLE);
    ...
    binding.detailTitle.setOnEditorActionListener((v, actionId, event) -> {
      ...
      binding.fragmentDetailContent.detailContent.setSelected(true);
      return false;
    });
  ...
  private void initViewContent() {
    ...
    binding.fragmentDetailContent.detailContent.setHtml(noteTmp.getContent());
  ...
  private void addTimestamp() {
    Editable editable = new SpannableStringBuilder(binding.fragmentDetailContent.detailContent.getHtml());
  ...
  void saveNote(OnNoteSaved mOnNoteSaved) {
    ...
    // Changed fields
    noteTmp.setTitle(getNoteTitle());
    noteTmp.setContent(mEditor.getHtml());
  ...
  private void tagNote(List<Tag> tags, Integer[] selectedTags, Note note) {
    ...
    if (Boolean.TRUE.equals(noteTmp.isChecklist())) {
      ...
      if (binding.fragmentDetailContent.detailContent.hasFocus()) {
        sb.insert(contentCursorPosition, " " + taggingResult.first + " ");
        binding.fragmentDetailContent.detailContent.setHtml(sb.toString());
        //binding.fragmentDetailContent.detailContent.setSelection(contentCursorPosition + taggingResult.first.length() + 1);
      } else {
  ...
  private void eventuallyRemoveDeselectedTags(List<Tag> tagsToRemove) {
    ...
    binding.fragmentDetailContent.detailContent.setHtml(contentWithoutTags);
  ...
  public void onEventMainThread(PushbulletReplyEvent pushbulletReplyEvent) {
    ...
    binding.fragmentDetailContent.detailContent.setHtml(text);
  }
